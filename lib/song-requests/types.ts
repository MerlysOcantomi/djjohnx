...
export type SongRequestRound = { id:string; name:string; status:RoundStatus; capacity:number; reserved_slots:number; reopen_status:"open"|"last_round"; message:string; created_at:string; updated_at:string }
